				...
				<div class="row">
					<div class="col-md-7" >
						<div class="mb-3 row">
							...
							<div class="col-md-9">
								<input name="name" class="form-control" type="text" value="" id="name" placeholder="Enter Gallery Name Here" >
							</div>
						</div>
						<div class="mb-3 row">
							<label for="name" class="col-md-3 col-form-label">Slug</label>
							<div class="col-md-9">
								<input name="slug" class="form-control" type="text" value="" id="name" placeholder="Enter Gallery Slug Here" >
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-7" >
						...
						<div class="mb-2 row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Gallery Pincode Here" value="index, follow" >
							</div>
						</div>
					</div>
